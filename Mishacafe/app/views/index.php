...
<body>
  ...
  <main class="main-content">
    ...
    <section id="productos" class="container top-products animar">
      ...
      <div class="container-products">
        ...
        <div class="card-product">
          ...
          <div class="content-card-product">
            <h3>Café con Pan</h3>
            <p class="price">$3.50 <span>$4.00</span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="galerias" class="gallery animar">
      <img src="/img/galeria1.1.jpg" alt="Gallery Img1" class="gallery-img-1" />
      <img src="/img/galeria2.1.jpg" alt="Gallery Img2" class="gallery-img-2" />
      <img src="/img/galeria3.1.jpg" alt="Gallery Img3" class="gallery-img-3" />
      <img src="/img/galeria4.jpg" alt="Gallery Img4" class="gallery-img-4" />
      <img src="/img/galeria5.jpg" alt="Gallery Img5" class="gallery-img-5" />
    </section>
        ...
        <div class="card-blog">
          ...
          <div class="content-blog">
            ...
            <p>
              ...
              corazón de todos los visitantes.
            </p>
          </div>
        </div>
        <!-- BLOG 3 -->
        <div class="card-blog">
          ...
          <div class="content-blog">
            ...
            <p>
              ...
              y cuidado de gatos abandonados.
            </p>
          </div>
        </div>
      </div>
    ...
    <section>
      <h1>Bienvenido a Mishacafe</h1>
      <ul>
        <?php foreach ($productos as $producto): ?>
          <li><?= htmlspecialchars($producto['nombre']) ?> - S/ <?= number_format($producto['precio'], 2) ?></li>
        <?php endforeach; ?>
      </ul>
    </section>
  </main>
