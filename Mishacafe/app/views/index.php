...
<body>
  ...
  <!-- El resto de tu contenido principal aquí, elimina el header duplicado -->
  <!-- BANNER -->
  ...
  <main class="main-content">
    ...
    <section id="galerias" class="gallery animar">
      <img
        src="/Mishacafe/public/img/galeria1.1.jpg"
        alt="Gallery Img1"
        class="gallery-img-1" /><img
        src="/Mishacafe/public/img/galeria2.1.jpg"
        alt="Gallery Img2"
        class="gallery-img-2" /><img
        src="/Mishacafe/public/img/galeria3.1.jpg"
        alt="Gallery Img3"
        class="gallery-img-3" /><img
        src="/Mishacafe/public/img/galeria4.jpg"
        alt="Gallery Img4"
        class="gallery-img-4" /><img
        src="/Mishacafe/public/img/galeria5.jpg"
        alt="Gallery Img5"
        class="gallery-img-5" />
    </section>
    ...
    <section id="blog" class="container blogs animar">
      ...
      <div class="container-blogs">
        ...
        <div class="card-blog">
          <div class="container-img">
            <img src="/Mishacafe/public/img/blog1.1.PNG" alt="Imagen Blog 1" />
        ...
        <div class="card-blog">
          <div class="container-img">
            <img src="/Mishacafe/public/img/blog2.PNG" alt="Imagen Blog 2" />
            <div class="button-group-blog">
              <span>
                <i class="fa-solid fa-magnifying-glass"></i>
              </span>
        ...
        <div class="card-blog">
          <div class="container-img">
            <img src="/Mishacafe/public/img/blog3.PNG" alt="Imagen Blog 3" />
            <div class="button-group-blog">
              <span>
                <i class="fa-solid fa-magnifying-glass"></i>
              </span>
    ...
    <div class="container container-footer">
      <div class="menu-footer">
        <div class="contact-info">
          ...
          <ul>
            <li>Dirección: Chincha Chincha Alta</li>
            <li>Teléfono: 924754534</li>
            <li>Fax: 55555300</li>
            <li>EmaiL: Mishacafé@support.com</li>
          </ul>

          <div class="social-icons">
            <a href="https://www.facebook.com/gatu.peru" target="_blank">
              <span class="facebook">
                <i class="fa-brands fa-facebook-f"></i>
              </span>
            </a>
            <a href="https://twitter.com/gatuperu" target="_blank">
              <span class="twitter">
                <i class="fa-brands fa-twitter"></i>
              </span>
            </a>
            <a
              href="https://www.youtube.com/watch?v=FOb1d1JSVtU"
              target="_blank">
              <span class="youtube">
            ...
            <a
              href="https://es.pinterest.com/search/pins/?q=cafeterias%20peque%C3%B1as&rs=ac&len=9&source_id=ac_Ipt2itlz&eq=cafeteria&etslf=3751"
              target="_blank">
              <span class="pinterest">
                <i class="fa-brands fa-pinterest-p"></i>
              </span>
            </a>
            <a href="https://www.instagram.com/gatu.pe/" target="_blank">
      ...
      <div class="copyright">
        <p>Desarrollado por estudiantes UPSJB &copy; 2025</p>
      </div>
    </div>
  </footer>
</body>
